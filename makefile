CFLAGS=-O3 -std=c17 -Wall -Wextra -Wpedantic -Wconversion -fPIC -g -fopenmp -Xassembler -mrelax-relocations=no
...
CXXFLAGS=-O3 -std=c++17 -Wall -Wextra -Wpedantic -Wconversion -fPIC -g -fopenmp -Xassembler -mrelax-relocations=no
